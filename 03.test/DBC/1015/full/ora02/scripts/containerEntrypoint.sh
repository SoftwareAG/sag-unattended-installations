...
chmod u+x "$SUIF_INSTALL_INSTALLER_BIN" "$SUIF_PATCH_SUM_BOOTSTRAP_BIN"
...
createDbComponents(){
    ...
    echo "Try out the commands manually"
    # TODO: post-setup template for this
}

createDbComponents


# TODO: uncomment when adminer is ready
