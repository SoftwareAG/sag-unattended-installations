...
export SUIF_IS_ADMINISTRATOR_PASSWORD=${SUIF_APIGW_ADMINISTRATOR_PASSWORD:-"manage1"}

export SUIF_IS_OLD_ADMINISTRATOR_PASSWORD=${SUIF_APIGW_OLD_ADMINISTRATOR_PASSWORD:-"manage"}
export SUIF_IS_NEW_ADMINISTRATOR_PASSWORD="${SUIF_APIGW_ADMINISTRATOR_PASSWORD}"
