...
## Current Template
export SUIF_SETUP_TEMPLATE_IS_LICENSE_FILE=${SUIF_SETUP_TEMPLATE_YAI_LICENSE_FILE:-"/provide/path/to/IS-license.xml"}
export SUIF_SETUP_TEMPLATE_MFTGW_LICENSE_FILE=${SUIF_SETUP_TEMPLATE_YAI_LICENSE_FILE:-"/provide/path/to/MFT_Gateway_license.xml"}
...
export SUIF_SETUP_TEMPLATE_MFTGW_LICENSE_UrlEncoded=$(urlencode ${SUIF_SETUP_TEMPLATE_MFTGW_LICENSE_FILE})
